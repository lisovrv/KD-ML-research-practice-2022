...
def resnet18(num_classes: int = 100, in_channels: int = 3, checkpoint_path: Optional[str] = None):
    return create_model("resnet18", num_classes, in_channels, checkpoint_path)
